...
export default function ThanksPage() {
  ...
  const videoUrl = "https://fast.wistia.net/embed/iframe/92oy53i86x";
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage: `
            radial-gradient(circle at ${mousePosition.x}px ${mousePosition.y}px, rgba(94, 255, 0, 0.15), transparent 40%),
            radial-gradient(circle at 50% 50%, rgba(94, 255, 0, 0.1), transparent 70%)
          `,
        }}
      />
      ...
      >
        ...
        >
          <div className="absolute -inset-4 rounded-full bg-[#5eff00]/5 blur-xl opacity-75 group-hover:opacity-100 transition duration-1000 group-hover:duration-200 animate-pulse"></div>
          <Image
            src="/LOGO.png"
            alt="Henko AI"
            width={300}
            height={150}
            className="w-full h-auto drop-shadow-[0_0_20px_rgba(94,255,0,0.5)] relative z-10"
          />
        </motion.div>
        ...
        <div ref={heroRef} className="w-full max-w-4xl mx-auto mb-16">
          <motion.div
            ...
            style={{ y: y1 }}
          >
            <div className="absolute top-0 bottom-0 left-0 w-[3px] bg-[#5eff00]/30 rounded-full"></div>
            ...
            >
              ...
              <span className="relative inline-block">
                <span className="relative z-10 text-[#5eff00] font-bold">
                {" "}  "Confirmar llamada"{" "}
                </span>
                <span className="absolute inset-0 bg-[#5eff00]/20 blur-md -z-10 rounded-md"></span>
              </span>
        ...
        >
          En 20 días,<span className="relative z-10 text-[#5eff00] font-bold">{" "}creamos tu empleado IA{" "}</span>  listo para trabajar 24/7
        </motion.p>
        ...
        {/* <GlowingCard className="aspect-video w-full max-w-4xl mx-auto overflow-hidden">
            <div className="absolute inset-0 flex items-center justify-center bg-gray-900/80 backdrop-blur-sm">
              <motion.button
                className="w-16 h-16 bg-[#5eff00] rounded-full flex items-center justify-center shadow-[0_0_30px_rgba(94,255,0,0.7)]"
                whileHover={{ scale: 1.1, boxShadow: "0 0 40px rgba(94,255,0,0.9)" }}
                whileTap={{ scale: 0.9 }}
        ...
        <div id="casos-de-exito" className="max-w-4xl mx-auto mb-16">
          ...
          >
            <div className="flex items-center mb-4">
              <motion.div
                className="w-8 h-8 rounded-full bg-[#5eff00] flex items-center justify-center mr-3 shadow-[0_0_15px_rgba(94,255,0,0.7)]"
                whileHover={{
                  scale: 1.2,
                  boxShadow: "0 0 20px rgba(94,255,0,0.9)",
                }}
                transition={{ type: "spring", stiffness: 400, damping: 17 }}
              >
                <Plus className="h-5 w-5 text-black" />
              </motion.div>
              <h3 className="text-xl text-[#5eff00] font-medium">
                Caso de Éxito
              </h3>
            </div>
            <h2
            ...
            >
              ...
              <span className="relative inline-block">
                <span className="relative z-10 font-bold text-[#5eff00]">
            ...
            <div className="grid grid-cols-1 gap-8">
              {/* <GlowingCard className="bg-black/40 backdrop-blur-xl p-6">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <p className="text-sm">Henko & ITUC</p>
              ...
              {/* <GlowingCard className="relative aspect-video bg-black/40 backdrop-blur-xl overflow-hidden">
                <div className="absolute inset-0 flex items-center justify-center">
                  <motion.button
                    className="w-16 h-16 bg-[#5eff00] rounded-full flex items-center justify-center shadow-[0_0_20px_rgba(94,255,0,0.7)]"
                    whileHover={{
                      scale: 1.1,
                      boxShadow: "0 0 30px rgba(94,255,0,0.9)",
                    }}
                    whileTap={{ scale: 0.9 }}
                    transition={{ type: "spring", stiffness: 400, damping: 17 }}
                  >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <GlowingCard className="flex flex-col justify-center p-8 backdrop-blur-xl bg-black/30">
                <h3 className="text-xl md:text-2xl mb-4 font-light">
                  <span className="text-[#5eff00] font-medium">Resultados</span>
                </h3>
                <ul className="space-y-3">
                  <li className="flex items-start">
                    <div className="w-5 h-5 rounded-full bg-[#5eff00]/20 flex items-center justify-center mr-3 mt-1">
                      <Check className="h-3 w-3 text-[#5eff00]" />
                    </div>
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 border-b border-gray-800/50 pb-16">
            <GlowingCard className="text-center p-8 backdrop-blur-xl bg-black/30">
              ...
              >
                <span className="bg-clip-text text-transparent bg-gradient-to-r from-white via-[#5eff00] to-white">
                  80+
                </span>
              </motion.h2>
        ...
        <div className="w-full max-w-4xl mx-auto mb-16">
          ...
          >
            <GlowingCard className="aspect-square overflow-hidden">
              <Image
                src="/seba.jpg?height=500&width=500"
            ...
            <GlowingCard className="flex flex-col justify-center p-8 backdrop-blur-xl bg-black/30">
              <h3 className="text-3xl md:text-4xl mb-4 font-light">
                <span className="text-[#5eff00] font-medium">Co-Fundador</span>{" "}
                | Sebastián Domfrocht
              </h3>
              <p className="text-base sm:text-lg leading-relaxed">
                Sebastián es un emprendedor nato con más de 12 años de
                experiencia. Comenzó en el mundo de los negocios físicos
                abriendo gimnasios, vendiendo suplementos y ropa deportiva.
                Durante la pandemia vendió su empresa y dio el salto al mundo
                digital. Desde entonces, se ha especializado en estrategias de
                ventas online y marketing digital.
              </p>
              <p className="text-base sm:text-lg leading-relaxed mt-3 sm:mt-4">
                En 2023 fundó la agencia Henko Labs, y en 2024, junto a Ignacio,
                transformaron esa experiencia en HENKO AI, una plataforma
                diseñada para automatizar procesos de ventas y atención al
                cliente con inteligencia artificial, ayudando a negocios a
                escalar sin aumentar su equipo.
              </p>
            </GlowingCard>
          </motion.div>
          ...
          >
            <GlowingCard className="aspect-square overflow-hidden">
              <Image
                src="/Ignacio.jpg?height=500&width=500"
                alt="Co-Fundador portrait"
                width={500}
                height={500}
                className="w-full h-full object-cover transition-transform duration-700 hover:scale-110"
            ...
            <GlowingCard className="flex flex-col justify-center p-8 backdrop-blur-xl bg-black/30">
              ...
              <p className="text-base sm:text-lg leading-relaxed">
                Ignacio comenzó su camino emprendedor en 2019 dentro del mundo
                del e-commerce. En 2020 encontró su verdadera pasión: el
                marketing digital y la posibilidad de ayudar a otros negocios a
                escalar con sistemas predecibles.
              </p>
              <p className="text-base sm:text-lg leading-relaxed mt-3 sm:mt-4">
                Le apasiona formar equipos de alto rendimiento en programación y
                marketing digital, capaces de trabajar en sinergia para lograr
                los mejores resultados para las empresas que confían en su
                servicio.
              </p>
              <p className="text-base sm:text-lg leading-relaxed mt-3 sm:mt-4">
                Hoy, como cofundador de Henko AI, está enfocado en crear
                sistemas inteligentes que eliminen el caos operativo y permitan
                a las empresas vender más con menos esfuerzo humano.
              </p>
            </GlowingCard>
          </motion.div>
        </div>
        ...
        >
          <div id="preguntas-frecuentes" className="flex items-center mb-4">
            ...
            <h3 className="text-xl text-[#5eff00] font-medium">FAQs</h3>
          </div>
          ...
          <GlowingCard className="p-8 backdrop-blur-xl bg-black/30">
            <Accordion type="single" collapsible className="w-full">
              ...
              >
                <AccordionTrigger className="text-lg sm:text-xl hover:text-[#5eff00] transition-colors py-2 sm:py-3">
                ...
                <AccordionContent className="text-gray-300 text-sm sm:text-base leading-relaxed px-1">
                  ...
                  situación actual y ver si Henko AI puede ayudarte a escalar
                  sin aumentar estructura. Además como regalo te entregaremos la
      ...
      >
        <div className="flex justify-center gap-4 sm:gap-8">
          ...
          >
            <span>Preguntas Frecuentes</span>
            <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-[#5eff00] transition-all duration-300 group-hover:w-full shadow-[0_0_10px_rgba(94,255,0,0.7)]"></span>
          </Link>
          <Link
            href="#casos-de-exito"
            className="group relative text-sm md:text-base font-medium transition-colors hover:text-white"
